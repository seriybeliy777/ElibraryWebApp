...
namespace ELibraryWebApp
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<ELibraryContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
        ...
        {
            var roleManager = new ApplicationRoleManager(new RoleStore<ApplicationRole>(context.Get<ELibraryContext>()));
